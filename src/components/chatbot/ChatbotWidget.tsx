      ...
      {open ? null : (
        <div className="fixed bottom-[16px] right-[16px] z-40 flex items-center gap-[10px] sm:bottom-[24px] sm:right-[24px]">
          ...
          <button
            ...
            aria-expanded={open}
            className="relative inline-flex h-[56px] w-[56px] items-center justify-center rounded-full bg-lrfap-navy text-white shadow-[0_10px_24px_-8px_rgba(38,43,102,0.45)] transition-transform hover:scale-[1.04] hover:bg-lrfap-navy/95 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-lrfap-sky"
          >
            <MessageCircle
              aria-hidden="true"
              className="h-6 w-6"
